...
class SidebarManager {
    ...
    setSidebarSummary(html) {
        const preview = html ? html.substring(0, 100) + '...' : 'empty';
        console.log(`📋 ${this.LOG_PREFIX}: Setting summary:`, preview);
        ...
        if (!html) {
            console.log(`🧹 ${this.LOG_PREFIX}: Clearing summary`);
        ...
        console.log(`✅ ${this.LOG_PREFIX}: Setting HTML content`);
