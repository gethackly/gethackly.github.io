...
class TourManager {
    constructor() {
        this.steps = [
            { selector: '.branch-counter', title: 'Project Counter', content: 'Shows how many projects are left before the hackathon begins. Once we reach 50 projects, the 8-hour evaluation cycles start.', placement: 'bottom' },
            { selector: '.branch-row:first-child', title: 'Project List', content: 'This is the highest-ranked project. Click any row to open its details and work on files.', placement: 'right' },
            { selector: '.branch-details-inner', title: 'Branch Content', content: 'Here you can see and edit the project files. Click on any file to open it in the editor and make changes.', placement: 'left' },
            { selector: '.sidebar', title: 'Evaluation results', content: 'When you evaluate a prompt, detailed results and rationales appear here. This shows accuracy, reliability, and complexity scores.', placement: 'right' },
            { selector: '#leaderboardTab', title: 'Ranking', content: 'See how points are awarded and how ownership changes.', placement: 'left' }
        ];
        this.currentIndex = -1;
        this.overlayEl = null;
        this.tooltipEl = null;
